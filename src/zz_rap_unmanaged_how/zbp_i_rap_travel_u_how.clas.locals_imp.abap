...
CLASS lhc_Travel IMPLEMENTATION.
  ...
  METHOD create.
    ...
    LOOP AT entities ASSIGNING FIELD-SYMBOL(<entity>).
      ...
      DATA(legacy_entity_in) = CORRESPONDING /dmo/travel( <entity> MAPPING FROM ENTITY USING CONTROL ).
  ...
  METHOD update.
    ...
    LOOP AT entities ASSIGNING FIELD-SYMBOL(<entity>).
      ...
      legacy_entity_x-_intx = CORRESPONDING zsrap_travel_x_how( <entity> MAPPING FROM ENTITY ).
...
CLASS lsc_ZI_RAP_TRAVEL_U_HOW DEFINITION INHERITING FROM cl_abap_behavior_saver.
  PROTECTED SECTION.
...
CLASS lsc_ZI_RAP_TRAVEL_U_HOW IMPLEMENTATION.
