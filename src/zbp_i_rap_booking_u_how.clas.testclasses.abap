...
CLASS ltcl_integration_test IMPLEMENTATION.
  ...
  METHOD class_setup.
    cds_test_environment = cl_cds_test_environment=>create_for_multiple_cds( VALUE #( ( i_for_entity = 'zi_rap_travel_u_how' )
                                                                                      ( i_for_entity = 'zi_rap_booking_u_how' ) ) ).
  ENDMETHOD.
  ...
  METHOD create_travel.
    ...
    DATA travels_in TYPE TABLE FOR CREATE zi_rap_travel_u_how\\travel.
    ...
    MODIFY ENTITIES OF zi_rap_travel_u_how
      ENTITY Travel
    ...
    SELECT FROM zi_rap_travel_u_how
      FIELDS *
